...
function handleUpdate(payload) {
    return __awaiter(this, void 0, void 0, function () {
        var deviceid, climate, energy, switch_no, status, _a, temperature, humidity, sunlight, _b, voltage, current, power, unit, switchNo;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    deviceid = payload.deviceid, climate = payload.climate, energy = payload.energy, switch_no = payload.switch_no, status = payload.status;
                    if (!climate) return [3 /*break*/, 2];
                ...
                case 3:
                    ...
                    _c.label = 4;
                case 4:
                    if (!(switch_no && status)) return [3 /*break*/, 6];
                    switchNo = Number(String(switch_no).replace('S', ''));
